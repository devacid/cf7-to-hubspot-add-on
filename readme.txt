...
== Description ==
This is a FREE plugin which seamlessly integrates HubSpot forms with Contact Form 7 forms.
...
If you have any issues or questions about this plugin then please create a support request and we will get back to you shortly.
...
3. Search for \"CF7 HubSpot Forms Add-on For Contact Form 7\" (without the quotes of course) and click install.
4. After the plugin is installed activate the plugin.
5. That\'s it. Go ahead and start creating forms using Contact Form 7 and you will see a tab called \"HubSpot Form Integration\".
